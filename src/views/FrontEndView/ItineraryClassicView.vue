<template>
    ...
    <section class="section">
        <div class="container carouselWrap">
            <div>
                <carousel></carousel>
                <aside-bar @tab0="changeParagraph0" @tab1="changeParagraph1" @tab2="changeParagraph2" @tab3="changeParagraph3" @tab4="changeParagraph4" ></aside-bar>
            </div>
            <div class="infoWrap">
