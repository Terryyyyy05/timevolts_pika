        ...
        <div class="outterwrap">
            ...
            <div class="wrap">
                <div class="imgblock" @mouseover="btnHover"  @mouseleave="btnNoHover" >
                    ...
                    <router-link :to="info.type=='經典事件'?'/itiItineraryClassicView':'/itineraryPeriodView'" class="bg_accent morewrap" v-show="showBtn">
                        <span class="morespan">more</span>
                    </router-link>
                    <!-- <router-link :to="`/itiItineraryClassicView`" class="bg_accent morewrap" v-show="showBtn">
                        <span class="morespan">more</span>
                    </router-link> -->
                </div>                
                <div class="textblock">
...
export default{
    ...
    data(){
        return{
            showBtn: false,
            // urlMap: {
            //     "經典事件": '/itiItineraryClassicView',
            //     "奇聞軼事": '/itineraryPeriodView'
            // },
            information:[
                {   
                    type: "經典事件",
