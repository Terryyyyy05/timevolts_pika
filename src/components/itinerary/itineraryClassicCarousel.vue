        ...
        .scene {
            ...
            .carousel {
                ...
                .face {
                    ...
                    &:nth-of-type(4) {
                        transform: rotateY(270deg) rotate(0deg)
                            translateZ(105px);
                    }
                }
            }
            ...
            .scene {
                ...
                .carousel {
                    ...
                    .face {
                        ...
                        &:nth-of-type(2) {
                            transform: rotateY(60deg) rotate(-90deg)
                                translateZ(190px);
                        }
                        &:nth-of-type(3) {
                            transform: rotateY(120deg) rotate(-90deg)
                                translateZ(190px);
                        }
                        &:nth-of-type(4) {
                        ...
                        &:nth-of-type(5) {
                            transform: rotateY(240deg) rotate(-90deg)
                                translateZ(190px);
                        }
                        &:nth-of-type(6) {
                            transform: rotateY(300deg) rotate(-90deg)
                                translateZ(190px);
                        }
                    }
                }
