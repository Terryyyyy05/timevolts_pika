...
=======
    <div class="l-box-content">
      ...
      <div class="l-box-content-item">
        <span class="hashtag">{{ popupData.hashtag }}</span>
        <p class="content">{{ popupData.content }}</p>
        <!-- <router-link to="/history" class="content-link">>>點我看詳細</router-link> -->
      </div>
    </div>
  </div>
>>>>>>> irene
      ...
      itineraryData: [
        {
          ...
          content:
            "人類的歷史分成：史前時代及信使時代。「文字的出現」為畫分的依據，史前時代沒有文字，信使時代為文字開始。今天，我們將回到史前時代，建立屬於自己的莊園，面對嚴苛的大自然及猛獸努力存活下去。",
          content_link: "/itineraryClassicView",
...
>>>>>>> irene
            ...
            //       date: '2022-09-10',
            //       hashtag: '#經典行程 #中度危險 #歐洲 #美洲',
            //       content: '從1492年到1503年間，哥倫布完成了4次從西班牙到美洲的來回航行。這些航行都是由卡斯提亞王國資助的，標誌著歐洲人對美洲大陸的探險和殖民的開始，因此對西方歷史有著不可估量的重要性。儘管哥倫布面對日漸增多反對其觀點的證據，但仍然堅持認為他在歷次航行中所到過的地方就是馬可·波羅以及其他歐洲旅行家說描述過的亞洲大陸的一部分。',
            //       content_box: '',
            //       img: require(`@/assets/image/news/columbus.jpg`),
            //     }
            //   ],
            ...
            //       date: '2022-11-01',
            //       hashtag: '#歷史事件 #低危險度 #大洋洲',
            //       content: '發生在在1851年開始的澳洲淘金熱，大量工人從澳洲和其他地區前往挖掘黃金的情形。此處在先前已經多次發生挖掘出黃金的情形，但是新南威爾士州的政府一直壓制及隱瞞這個消息，因為他們擔心會因此而減少勞動人力，從而破壞經濟的穩定。但是隨著知情的人越來越多，政府也無法完全管轄，此熱潮才逐漸爆發...',
            //       content_box: '',
            //       img: require(`@/assets/image/news/australia.jpg`),
            //     },
            //     {
            ...
            //       date: '2022-10-15',
            //       hashtag: '#歷史事件 #低危險度 #非洲',
            //       content: '馬利帝國，又名曼丁帝國或曼迪聯邦，是西非中世紀時的一個強大伊斯蘭教帝國，是北部非洲以南的廣闊內陸中歷史最悠久的國家，古代最重要的伊斯蘭文化與財富中心之一。帝國語言為曼丁哥語，為是當時西非最大的國家，其語言、法律及風俗也影響當時西非各國的文化許多。',
            //       content_box: '',
            //       img: require(`@/assets/image/news/mali-empire.jpg`),
            //     },
            //     {
            ...
            //       date: '2022-10-01',
            //       hashtag: '#歷史事件 #高危險度 #歐洲',
            //       content: '十字軍東征，伊斯蘭世界稱為法蘭克人入侵，是一系列在教皇的准許下的戰爭，由西歐的封建領地主和騎士對被他們視為侵略者的伊斯蘭政權發動持續近200年的戰爭。十字軍東征最初參與成員，例如：騎士、商人、農民，多數是自願的，受拜占庭帝國之邀、以及羅馬教廷的認可下，參與奪回聖地戰爭。這些十字軍也非拜占庭帝國主力部隊。東正教徒也參加其中幾次十字軍。',
            //       content_box: '',
            //       img: require(`@/assets/image/news/crusades.jpg`),
            //     },
            //     {
            ...
            //       date: '2022-09-15',
            //       hashtag: '#歷史事件 #中危險度 #西亞',
            //       content: '耶穌被逮捕後以十字架處死的事件，一般認為發生在公元1世紀的猶太行省，最可能在公元30到33年之間。雖然歷史學家對這個事件的準確細節並沒有達成共識，但這個事件在《聖經》中正統的《四福音》皆有描述，在《新約書信》中有提及，而且也被其他古代資料證實，除了基督徒的資料以外，並也被異教徒的史料證實，學者多數認為這是一個歷史事件。',
            //       content_box: '',
            //       img: require(`@/assets/image/news/jesus.jpg`),
            //     },
            //     {
            ...
            //       date: '2022-09-01',
            //       hashtag: '#歷史事件 #低危險度 #西亞',
            //       content: '穆罕默德出生在麥加的古萊什族的哈希姆家族，為當時麥加的望族，因此穆罕默德的幼年環境相當地富裕。穆罕默德的父親在穆罕默德出世前就不幸隨商隊病死沙漠，因此穆罕默德的童年是隨他的叔父阿布·塔里布照料至大。古蘭經是先知穆罕默德透過二十三年接受真主啓示並口述記下並傳達給身邊弟子們背誦記下來的。',
            //       content_box: '',
            //       img: require(`@/assets/image/news/muhammad.jpg`),
            //     },
            //     {
            ...
            //       date: '2022-08-15',
            //       hashtag: '#奇聞軼事 #低危險度 #蘇格蘭  #近代歷史',
            //       content: '尼斯湖水怪絕對是上個世紀最有名的一個不明生物。最早有人看到尼斯湖水怪是在1933年4月份的時候，直到今天80多年過去了，它的目擊情報從來沒有斷過。你相不相信水怪的存在呢?我們將帶您穿越回1933年，讓您親自見證!此行程穿越年份較短，時代背景與現今較無差異，適合新手體驗!',
            //       content_box: '',
            //       img: require(`@/assets/image/news/nessiteras.jpg`),
            //     },
            //     {
            ...
            //       date: '2022-08-01',
            //       hashtag: '#奇聞軼事 #高危險度 #懸疑冒險 #亞洲',
            //       content: '2004年1月8日，一名日本網友以葉純（はすみ）的名義進行文字直播，兼尋求協助。她表示自己在新濱松站登上西鹿島線後，列車駛了一段長時間都沒有到站，之後列車終於在一個附近完全是荒山野嶺無人的「如月車站」停下，他以電話向警方求救也無法得到協助。她在後文表示，自己在穿過一條隧道後，發現有車主願意送自己到附近的車站。此後她停止發文，音訊全無.... ',
            //       content_box: '',
            //       img: require(`@/assets/image/news/kisaragi.jpg`),
            //     },
            //     {
...
<<<<<<< HEAD
    methods: {
        ...
        getData() {
            fetch(
                "http://localhost/timevolts_pika/public/phpfile/getProducts.php"
            )
                .then((res) => res.json())
                .then((json) => {
                    this.result = json;
